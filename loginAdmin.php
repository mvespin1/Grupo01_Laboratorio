        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">VERIS - Admin</h2>
                </div>
            </div>
            <div class="row justify-content-center">
			...
			$html .='   </select>
							...
							<div class="form-group text-center">
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input" id="customSwitches" name="2fa">
							...
							<div class="form-group">
							<a href="cerrar.php" class="form-control btn btn-secondary submit px-3" style="background-color: rgb(82, 82, 82);">CERRAR</a>
							</div>
                        </form>
                    </div>
                </div>
