...
<body>
	...
	include_once("../clases/class.paciente.php");
	...
	if (isset($_GET['d'])) {
		...
		if ($op == "del") {
			echo $v->delete_paciente($PacienteID);
		} elseif ($op == "det") {
			echo $v->get_detail_paciente($PacienteID);
		} elseif ($op == "new") {
			echo $v->get_form();
		} elseif ($op == "act") {
			echo $v->get_form($PacienteID);
		}
